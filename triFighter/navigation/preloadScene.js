...
*/
    ...
    this.load.spritesheet(
      "triFighter",
      "./assets/triFighter/triFighterFullMoveSet.png",
      { frameWidth: 256, frameHeight: 256, endFrame: 16 }
    );
    ...
    this.load.spritesheet(
      "squareFighter",
      "./assets/squareFighter/squareFighterMoves.png",
      { frameWidth: 32, frameHeight: 32, endFrame: 10 }
    );
