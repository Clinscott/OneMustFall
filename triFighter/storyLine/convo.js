const convo = [
  {
    ...
    options: [
      ...
      {
        key: "D",
        option: "Help us TriAngle, you are our only hope",
        nextPage: 2,
      },
    ],
  },
    ...
    options: [
      {
        key: "A",
        option:
          "Because we have given unto you your life, and we need you to aid us now!",
        nextPage: 3,
      },
      {
        key: "D",
        option:
          "Please TriAngle, if you fail us, you too shall fall to the wrath of the One of Infinite Angles.",
        nextPage: 4,
      },
    ],
  },
  {
    ...
    page: 3,
    narrative:
      "That seams like a very good reason, but really, what's in it for me?",
    admin: "generalGas",
    options: [
      {
        key: "A",
        option:
          "The One of Infinite Angles searches for all our destruction, yours included. This base is the last hope.",
        nextPage: 4,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        key: "D",
        option: "Once again TriAngle, help us, for you are our only hope",
        nextPage: 5,
      },
    ],
  },
  {
    ...
    admin: "generalGas",
    options: [{ key: "A", option: "Thank You", nextPage: 6 }],
  },
  {
    character: "triAngle",
    page: 6,
    ...
    admin: "generalGas",
    options: [{ key: "A", option: "...", nextPage: 6 }],
  },
  {
    character: "triAngle",
    page: 7,
    ...
    options: [
      {
        key: "A",
        option:
          "With those angles you picked up we can improve you. But at a cost.",
        nextPage: 9,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        key: "D",
        option: "We can make your attacks more effective.",
        nextPage: 12,
      },
    ],
  },
    ...
    options: [
      {
        key: "A",
        option:
          "I am afraid not. We need more angles to improve something else.",
        nextPage: 16,
      },
    ],
  },
    ...
    options: [
      {
        key: "A",
        option:
          "Have no fear, for the enemy builds anew. Soon they will come again",
        nextPage: 17,
      },
    ],
  },
  {
    ...
    options: [
      {
        key: "A",
        option: "*mumbling* That is what the last one said.",
        nextPage: 18,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        key: "D",
        option: "May we be forgiven for what we had to do...",
        nextPage: 18,
      },
    ],
  },
  {
    ...
    options: [
      {
        key: "A",
        option: "See the power of your fists in action.",
        nextPage: 20,
      },
      {
        key: "D",
        option: "You are the saviour of mankind indeed.",
        nextPage: 20,
      },
    ],
  },
  {
    ...
    options: [
      {
        key: "A",
        option: "The enemy is nowhere near done. More foes will come.",
        nextPage: 21,
      },
      {
        key: "D",
        option: "You must prepare yourself once again.",
        nextPage: 21,
      },
    ],
  },
  {
    ...
    admin: "generalGas",
    options: [{ key: "A", option: "Yes fighter you do.", nextPage: 9 }],
  },
];
